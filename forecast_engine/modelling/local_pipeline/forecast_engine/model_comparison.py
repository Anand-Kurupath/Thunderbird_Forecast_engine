import pandas as pd
import numpy as np
import forecast_engine.modelling.local_pipeline.anomaly_detection.pipeline as anomaly_pipeline
import forecast_engine.modelling.local_pipeline.forecast_engine.model_list as model_list_pipeline
import forecast_engine.modelling.local_pipeline.error_metrics.nodes as error_metrics
import forecast_engine.modelling.local_pipeline.models.ensembles.ensemble_engine as ensemble_engine
import forecast_engine.modelling.local_pipeline.forecast_engine.analysis_dataframe as analysis_dataframe
import forecast_engine.modelling.local_pipeline.forecast_engine.model_selection as model_selection
...
def model_comparison_function(ti, series_flag,row_counter,list_of_models,debug_flag,debug_models,validation_window, max_validation, variable_list,single_series,oos_length,outlier_flag,select_variable_flag):
  ...
  model_list = model_list_pipeline.model_list_function(ti1,series_flag,oos_length,list_of_models,index,row_counter,debug_flag,debug_models,n_splits,validation_window,max_validation,variable_list,single_series)
