...
def individual_model_run_function(model_name,multivariate_models,list_of_models,ti_mv,ti,oos_length,row_counter,debug_models,n_splits,validation_window,max_validation,variable_list,model_list,original_val_forecast_list,original_oos_forecast_list,original_fitted_values_list,var_coeff):
  ...
  try:
    ...
    print(f"{model_name}:errored out,{traceback.format_exc()}")
