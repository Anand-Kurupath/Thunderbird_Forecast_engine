def ml_forecast(train, regular_series, multivariate_models, hyper_paramerter_space, horizon, processed_data_path, cores_to_use = -1,lags=[1,2,3,4,6,9,12],static_features = None, dynamic_features = None,oos=None):
    import pandas as pd
    ...
    params_xgb = hyper_paramerter_space['params_xgb']
    params_rf = hyper_paramerter_space['params_rf']
    params_lsvr = hyper_paramerter_space['params_lsvr']
    params_ridge = hyper_paramerter_space['params_ridge']
    params_histgb = hyper_paramerter_space['params_histgb']
    params_knn = hyper_paramerter_space['params_knn']
    params_mlp = hyper_paramerter_space['params_mlp']
        
    models_mv = [XGBRegressor(random_state=0, **params_xgb),
